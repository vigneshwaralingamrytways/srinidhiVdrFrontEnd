...
`;
const SearchSubMenu = ({ item,sidebarOpen,handleDocumentType }) => {
  ...
  // Determine the appropriate component based on item.issearch
 // const SidebarComponent = item.issearch ? SidebarLink : StyledLink;
  return (
    <>
      ...
      <SidebarLink
        ...
        onClick={()=>handleDocumentType(item)}
      >
